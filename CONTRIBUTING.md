...
DCAF-ABE is an open source project, and community contributions are essential for
keeping it great.
...
* Submit a ticket for your issue, assuming one does not already exist.
  * DCAF-ABE tickets are filed on the GitHub project:
    https://github.com/csc/dcaf-abe/issues
...
We really want DCAF-ABE to be simple to contribute to, and to ensure that you can
...
speed quickly.  You can always reach out and ask for help by email or the gitter room for the project.

## Discuss Your Change

You should start by discussing your change in public; [open an issue describing the bug or feature][bugs].  Once an issue exists for a bug or feature, all discussion should take place in
...
Until a stable version of DCAF-ABE is shipped, there is only one branch:
`master`.  All changes target that branch.  Right now any change committed to `master` must be considered "live".
...
DCAF-ABE is an open project: any contributor can become a committer.  Being a
committer comes with great responsibility: your decisions directly shape the
community, and the effectiveness, of the DCAF-ABE project.  You will probably
...
[bugs]:            https://github.com/csc/dcaf-abe/issues
